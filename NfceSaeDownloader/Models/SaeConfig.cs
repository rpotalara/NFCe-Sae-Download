...
namespace NfceSaeDownloader.Models
{
    public sealed class SaeConfig
    {
        ...
        public string ListagemNamespace { get; set; }
        public string DownloadNamespace { get; set; }
        public string ListagemSoapAction { get; set; }
        public string DownloadSoapAction { get; set; }
